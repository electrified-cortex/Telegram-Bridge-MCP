      ...
      if (topic === "compacted") {
        return toResult({
          content: [
            ...
            "4. Test Telegram: dequeue(max_wait: 0) — drain any pending messages.",
      ...
      if (topic === "dequeue") {
        return toResult({
          content: [
            ...
            "  → timed_out  → scan for work → dequeue",
            ...
            "5. Default max_wait always. Omit max_wait — session default handles blocking. Exception: max_wait: 0 when draining pending after reconnect.",
