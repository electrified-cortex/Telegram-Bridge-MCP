...
const TOOL_INDEX: Record<string, string> = {
  ...
  send_text: "Send a plain or Markdown text message to the Telegram chat.",
  send_message: "Low-level send with full Telegram options (parse_mode, reply, etc.).",
  send_file: "Upload and send a file to the Telegram chat.",
  send_text_as_voice: "Convert text to speech and send as a Telegram voice message.",
  ...
  set_voice: "Configure TTS voice settings for send_text_as_voice.",
