...
Use send_new_checklist (standalone tool) to create the initial checklist and get message_id.
...
message_id: ID of checklist message to update (required; from send_new_checklist)
...
## Pattern
1. send_new_checklist(title: "...", steps: [...], token: ...) → { message_id: 42 }
