...
Multiple pods (Curator, Overseer, BT, ZL) load this skill — it's unclear which copy each actually resolves.
...
4. **Audit** which pods (Curator, Overseer, BT, ZL) actually load which copy — check their skills
...
- [ ] All 4+ pods (Curator, Overseer, BT, ZL) confirmed loading canonical version
