...
client-side TTS chunking. Post the plan to the Overseer outbox; the Curator will
...
3. **Post plan** to Overseer outbox with subject line `tmcp-tts-chunking-plan`
...
**Note**: Foreman reads code, writes plan, posts to outbox. Overseer forwards to Curator.
