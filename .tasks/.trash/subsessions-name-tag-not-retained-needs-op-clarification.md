...
## Gate review (Overseer, 2026-06-20)

BOUNCE — open question: "confirm expected behavior with operator (full host name tag vs topic chip)." Without operator clarification on the exact inheritance semantics, the acceptance criteria cannot be defined. Also missing: proper YAML frontmatter, explicit ACs, scope, delegation. Move to needs-refinement; surface to operator before speccing.
