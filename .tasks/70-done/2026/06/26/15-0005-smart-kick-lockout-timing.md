...
ordering_note: "Implement BEFORE 10-0009 (kick→notify rename). This task adds profile/kick-lockout; 10-0009 then renames it to profile/notify-lockout. Do not implement after 10-0009 without updating naming throughout spec."
---
