...
needs_operator: true
blocked_on: "Curator must clarify: (1) is task about removing watcher-restart step only? (2) does Monitor TaskCreate subscription now survive compaction? (3) has this been superseded by post-compact auto-recovery bridge feature?"
---
